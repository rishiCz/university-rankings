const NavigationBar = () => {
  // This component renders a navigation bar from flowbite for the University Rankings application.
  // it is not functional, but it is a static navigation bar that can be used in the application.
  return (
    <>
      <nav className="bg-white border-gray-200 dark:bg-gray-900 border-b border-b-gray-700">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Flowbite Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">University Rankings</span>
          </a>
